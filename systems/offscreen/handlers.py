"""systems/scheduler_handlers.py — Event resolution handlers for the WorldScheduler.
...
def handle_finish_work(world: Any, eid: int, event_type: str,
    ...
    if job == "farming":
        ...
        if home:
            ...
            add_to_stockpile(world, home.subzone,
...
def schedule_hunger_event(world: Any, eid: int, scheduler: Any,
                          game_time: float) -> None:
...
_schedule_hunger_event = schedule_hunger_event
