"""systems/actions/player_attacks.py — Melee and ranged player attack actions."""
...
from systems.combat import attack_entity, get_hitbox_targets
from systems.combat.attacks import get_entity_weapon_stats
...
def player_melee_attack(app, scene) -> AttackResult | None:
    ...
    if not app.world.has(player_eid, CombatStats):
        return result
...
def player_ranged_attack(app, scene) -> AttackResult | None:
    ...
    combat = app.world.get(player_eid, CombatStats)
