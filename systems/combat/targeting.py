"""systems/combat/targeting.py — Target acquisition and ally queries.
...
from systems.ai.perception import (
    find_player, find_nearest_enemy, in_vision_cone,
)
from systems.combat.allies import PointProxy, iter_same_faction_allies

# ── Re-exports so existing ``from systems.combat.targeting import …``
#    in tests and other callers keeps working after the split. ────────
from systems.combat.fireline import (           # noqa: F401
    FireLine, get_ally_fire_lines,
    point_fire_line_dist, fire_line_dodge_vector,
    request_clear_fire_line,
)
from systems.combat.tactical import (           # noqa: F401
