"""systems/ai/defense.py — Defensive / survival AI helpers.
...
from systems.ai.perception import find_player, find_nearest_enemy, hp_ratio
...
def try_heal(world: World, eid: int, brain: Brain, s: dict,
    ...
    ``systems.inventory_consume.consume_best_heal``.
    """
