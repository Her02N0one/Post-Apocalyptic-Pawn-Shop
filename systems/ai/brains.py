"""systems/ai/brains.py — Brain registry and AI runner.
...
def tick_ai(world: World, dt: float):
    ...
    for eid, brain in world.all_of(Brain):
        ...
        if world.has(eid, Threat) and world.has(eid, AttackConfig):
            from systems.ai.perception import should_engage
            from systems.combat.engagement import tick_combat_fsm
...
from systems.ai import wander as _wander                              # noqa: F401, E402
from systems.combat import engagement as _combat_engagement            # noqa: F401, E402
from systems.ai import villager as _villager                           # noqa: F401, E402
