    ...
    "sculpt": {
        ...
        "actions": {
            ...
            "ceiling": {
                ...
                "Scroll": "Extend/retract wall above",
                "Sh+Scrl": "Snap grid",
            },
            "layer2": {
                "LMB": "Raise aimed surface",
                "Sh+LMB": "Raise ceil2",
                "Ct+LMB": "Remove layer 2",
                "RMB": "Lower aimed surface",
                "Sh+RMB": "Lower ceil2",
                "Scroll": "Extend wall above ceil / raise floor",
                "T": "Toggle ceil2",
                "R": "Reset L2",
                "Del": "Clear L2 cell",
                "L": "Flatten L2  Sh+L=ceil2",
            },
            "none": {
                "LMB": "Aim at surface",
            },
        ...
        "keys_layer2": "T=toggle ceil2  R=reset L2  Del=clear L2  L=flatten  Sh+L=ceil2  X=exit L2",
    },
    "paint": {
        "title": "Paint",
        "actions": {
